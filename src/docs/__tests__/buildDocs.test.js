...
describe('BuildDocs', () => {
  ...
  it('should setup api docs and create a predictable output', () => {
    ...
    const [helloWorld] = buildDocs({ ...OPTIONS, dataPath: apiFixture.dir, docsPath: 'lorem-ipsum' });
  ...
  it('should handle additional response content types', () => {
    ...
    const [html, svg] = buildDocs({ ...OPTIONS, dataPath: htmlFixture.dir, docsPath: 'lorem-ipsum' });
