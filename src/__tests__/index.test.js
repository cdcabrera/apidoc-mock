...
describe('ApiDocMock', () => {
  ...
  it('should setup api docs and create a predictable output', () => {
    ...
    const [helloWorld] = setupDocs({ ...OPTIONS, dataPath: apiFixture.dir, docsPath: 'lorem-ipsum' });
  ...
  it('should handle additional response content types', () => {
    ...
    const [html, svg] = setupDocs({ ...OPTIONS, dataPath: htmlFixture.dir, docsPath: 'lorem-ipsum' });
